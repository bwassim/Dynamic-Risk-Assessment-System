...
def model_predictions(file_name=None):
    ...
    print(f"The prediction for the {len(prediction)} test values are: {list(prediction)}")
...
def missing_data():
    ...
    print(f"The percentage of NA values for each columns is given by \n: {na_percent}")
...
def summary_statistics(filename=None):
    ...
    print(f'Diagnostics: summary statistics:[mean, median, std] \n {lst_stat}')
    return lst_stat
